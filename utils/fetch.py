...
# JSON outputs land in output/data/. Markdown deliverables (sec_report.md)
# stay in output/. This keeps the user-facing report findable while pushing
# the machine-readable artifacts into a tidy subdirectory.
...
# clean for the human-facing artifacts.
