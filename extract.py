...
from fetch import OUTPUT_DIR, FILINGS_DIR
...
# Load .env from the script's directory (where the user has saved the key)
...
- "eps_guidance_provided": Same standard, for EPS or net income.
